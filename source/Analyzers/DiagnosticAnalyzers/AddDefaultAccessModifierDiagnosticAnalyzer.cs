...
using static Roslynator.CSharp.Refactorings.AddDefaultAccessModifierRefactoring;

namespace Roslynator.CSharp.DiagnosticAnalyzers
{
    [DiagnosticAnalyzer(LanguageNames.CSharp)]
    public class AddDefaultAccessModifierDiagnosticAnalyzer : BaseDiagnosticAnalyzer
    {
