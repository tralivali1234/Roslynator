...
using static Roslynator.CSharp.Refactorings.AddEmptyLineAfterEmbeddedStatementRefactoring;

namespace Roslynator.CSharp.DiagnosticAnalyzers
{
    [DiagnosticAnalyzer(LanguageNames.CSharp)]
    public class AddEmptyLineAfterEmbeddedStatementDiagnosticAnalyzer : BaseDiagnosticAnalyzer
    {
