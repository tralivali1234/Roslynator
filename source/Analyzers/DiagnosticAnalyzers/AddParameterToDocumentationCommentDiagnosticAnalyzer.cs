...
using static Roslynator.CSharp.Refactorings.DocumentationComment.AddParameterToDocumentationCommentRefactoring;

namespace Roslynator.CSharp.DiagnosticAnalyzers
{
    [DiagnosticAnalyzer(LanguageNames.CSharp)]
    public class AddParameterToDocumentationCommentDiagnosticAnalyzer : BaseDiagnosticAnalyzer
    {
